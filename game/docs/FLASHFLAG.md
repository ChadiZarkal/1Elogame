...
2. L'hote choisit un test standard ou cree un test perso (10 questions).
...
5. Le questionnaire defile question par question.
6. Le recap final affiche score total, niveau de risque, detail des reponses.
