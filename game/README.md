...
6. `013_flashflag_quiz.sql` — Flash Flag schema *(game removed; kept as migration history)*
7. `014_flashflag_seed_standard.sql` — Flash Flag seed data *(game removed; kept as migration history)*
