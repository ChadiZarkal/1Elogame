    ...
    <main id="main-content" className="legal-page">
      <div className="legal-page__container">
        ...
        <section className="legal-page__section">
          ...
          <p>
            Ces scripts se chargent à l&apos;ouverture des pages concernées. La régie et ses
            partenaires peuvent déposer des cookies et utiliser des identifiants techniques pour
            mesurer l&apos;affichage des annonces et les adapter à vos visites antérieures sur ce
          ...
          <p>
            <strong>Pour vous y opposer</strong>, plusieurs moyens sont à votre main : régler votre
            navigateur pour bloquer les cookies tiers, installer un bloqueur de publicité, ou
            utiliser les liens d&apos;opposition ci-dessous. Vous pouvez aussi nous écrire à{' '}
            <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> pour exercer votre droit
            d&apos;opposition.
          </p>
          <p>
