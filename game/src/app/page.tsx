...
const CARDS_DATA: Record<PersonaKey, {
  ...
  group: {
    ...
    tag: '👥 JEU DE GROUPE',
    title: 'LE PIRE DES QUATRE',
    tagline: 'Désigner le comportement le moins supportable.',
    desc: 'Quatre comportements s\'affichent. Vous désignez celui que vous supporteriez le moins, puis les quatre se classent selon la communauté.',
    bullets: ['👥 Solo ou groupe', '🚩 Le pire parmi quatre', '📊 Le classement de la communauté'],
    cta: 'LANCER LE DUEL',
    href: '/jeu',
    emoji: '🔥'
  },
